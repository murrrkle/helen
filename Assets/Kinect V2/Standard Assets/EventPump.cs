extern alias SocketIoClientDotNet;
extern alias WebSocket4Net;
...
namespace Helper
{
    internal class EventPump : UnityEngine.MonoBehaviour
    {
        ...
        private Queue<SocketIoClientDotNet::System.Action> m_Queue = new Queue<SocketIoClientDotNet::System.Action>();
        ...
        public void Enqueue(SocketIoClientDotNet::System.Action action)
        {
            lock (m_Queue)
            {
